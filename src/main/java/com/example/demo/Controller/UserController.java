...
public class UserController {
    ...
    public ResponseEntity<String> updateUserPdf(
            @PathVariable Long id,
            @RequestParam("documentType") String documentType,
            @RequestParam("file") MultipartFile file) {
        String result = userServices.updateUserPdf(id, documentType, file);
        if (result.equals("Usuario no encontrado") || result.equals("Tipo de documento no válido")) {
    ...
    public ResponseEntity<byte[]> getUserPdf(
            @PathVariable Long id,
            @RequestParam("documentType") String documentType) {
        byte[] fileData = userServices.getUserPdf(id, documentType);
        if (fileData == null) {
